...
import profile_img from '../../assets/display_pic_1.svg'
const About = () => {
  return (
    ...
    <div className="about-sections">
        <div className="about-left">
            <img src={profile_img} className='display-picture' alt="" />
        </div>
        <div className="about-right">
           <div className="about-para">
           <p>
            Hello, I'm Habiba Rashid Lamiya, a dynamic individual driven by a passion for technology and innovation. Currently, I am working as a Software Developer and SQA at <a href="https://www.beratensoftware.com/" target="_blank" className='company-name'>Beraten Software Corporation</a>, a USA-based IT firm. Previously, I worked at <a href="https://womenindigital.net/" target="_blank" className='company-name'>Women in Digital </a>as a Junior Software Developer & a part-time Blockchain Instructor. I am still associated with Women in Digital as a part-time Blockchain Instructor, continuing to share my knowledge and skills with aspiring learners.
           ...
           <div className="about-skills">
             ...
             <div className="about-skill">
              <p>PHP & Laravel</p><hr style={{width:"90%"}}/>
             </div>
             {/* <div className="about-skill">
